...
export const gameText: Record<Language, { labels: Record<GameKind, string>; descriptions: Record<GameKind, string> }> = {
  ar: {
    ...
    descriptions: {
      ...
      'trix-solo': 'تركس فردي بدون شراكة',
      'trix-partners': 'تركس شراكة، اللاعب المقابل شريكك',
      complex: '4 ممالك، كل مملكة فيها كومبلكس وتركس',
      'complex-solo': 'كومبلكس فردي: كومبلكس وتركس في كل مملكة',
      'complex-partners': 'كومبلكس شراكة: اللاعب المقابل شريكك ونقاط الشركاء تُجمع',
  ...
  en: {
    labels: {
      ...
      trix: 'Trix',
      'trix-solo': 'Trix Solo',
      'trix-partners': 'Trix Partners',
      complex: 'Complex',
      'complex-solo': 'Complex Solo',
      'complex-partners': 'Complex Partners',
      tarneeb: 'Tarneeb',
    ...
    descriptions: {
      ...
      'trix-solo': 'Solo Trix across 4 kingdoms.',
      'trix-partners': 'Partnership Trix with opposite players paired.',
      complex: '4 kingdoms, each with Complex and Trix requests.',
      'complex-solo': 'Solo Complex with Complex and Trix requests per kingdom.',
      'complex-partners': 'Partnership Complex with opposite players paired.',
